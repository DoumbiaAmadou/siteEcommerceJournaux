 ...
 * @ORM\Entity(repositoryClass="journalBundle\Repository\ProduitsRepository")
 */
class Produits
{
    /**
   ...
   /**
     ...
     * Get categorie
     *
     * @return \journalBundle\Entity\Categorie 
     */
     ...
     * Set tva
     *
     * @param \journalBundle\Entity\Tva $tva
     * @return Produits
     */
    public function setTva(\journalBundle\Entity\Tva $tva)
    {
        $this->tva = $tva;
     ...
     * Get tva
     *
     * @return \journalBundle\Entity\Tva 
     */
